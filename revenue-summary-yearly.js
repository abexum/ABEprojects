define([
    ...
    function execute() {
        ...
        s.load({id: 'customsearch_rev_summary_advertisers'}).run().each(res => {
            // log.audit({
            //     title: 'in rev_summary_advertisers',
            ...
            if (!clientId) return true; // skip the grand total
            ...
            log.audit({
                title: 'three year ' + year + ' for client id ' +  clientId, 
                details: total
            });
        ...
        function getExistingRecords() {
            ...
            s.create({
                ...
                if (yearTotals[advertiser] == undefined) {
                    log.debug({
                        title: 'no year totals found for advertiser ' + res.getText({name: 'custrecord_rev_year_advertiser'}), 
                        details: 'advertiser internal id ' + advertiser
                    });
                    return true;
                } else {
                    // log.audit({
                    //     title: 'year totals found for advertiser ' + res.getText({name: 'custrecord_rev_year_advertiser'}), 
                    //     details: 'advertiser internal id ' + advertiser + ' ... pitch ... ' + pitch
                    // });
                }
